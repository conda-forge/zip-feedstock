...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/zip-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/zip-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/zip-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/zip-feedstock)
...
Once the `conda-forge` channel has been enabled, `zip` can be installed with:

```
conda install zip
```

It is possible to list all of the versions of `zip` available on your platform with:
